...
<head>
        ...
        <title>Personal Dynamic Portfolio </title>
        ...
        <header>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.php" class="navbar-brand logo-sticky-none"><img src="front_end_assets/img/logo/lgo.png" alt="Logo" width="10%"><h2 style="font-color='Black'">Casual Creator</h2></a>
                                    <a href="index.php" class="navbar-brand s-logo-none"><img src="front_end_assets/img/logo/lgo.png" alt="Logo" width="15%"></a>
            ...
            <div class="extra-info">
                ...
                <div class="logo-side mb-30">
                    <a href="index-2.html">
                        <img src="front_end_assets/img/logo/lgo.png" alt="" width="20%" /> <h2 style="font-color='Black'">Casual Creator</h2>
                    </a>
                </div>
            ...
            <section id="about" class="about-area primary-bg pt-120 pb-120">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about-img">
                                <img src="front_end_assets/img/banner/com.jpg" title="me-01" alt="me-01" width="90%">
                            </div>
                        </div>
